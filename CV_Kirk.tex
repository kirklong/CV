...
04/2019 --		& 	\textbf{Identifying accreting x-ray binaries}, Boise State University \vspace{1mm} \\
			&	Mentored by Dr. Daryl Macomb, code sample available at: \url{https://github.com/kirklong/Research}\\
...
08/2018 --		& 	\textbf{Physics Lab Instructor}, Boise State University Department of Physics \vspace{1mm} \\
      ...
      & $\bullet$ PHYS 111 (General Physics I, Fa 2018 \& Su 2020)\\
      ...
      & $\bullet$ PHYS 212 (General Physics II for Scientists and Engineers, Su 2020) \\
      & \\
08/2018 -- 08/2020   &   \textbf{Physics Tutor}, Boise State University Department of Physics \vspace{1mm} \\
      & 1/2 students selected by Department to host drop-in tutoring lab.\\
      & Mostly tutored lower-division classes but occasionally helped more advanced students.\\
...
01/2019 --    &   \textbf{Volunteer}, Idaho Department of Corrections \\
      & Inspired by \textit{Just Mercy} (\textbf{Stevenson}) to start program for inmates to learn STEM skills.\vspace{2mm} \\
...
\section {Outreach}
\begin{tabular}{ll}
06/2015 -- 08/2020   &   \textbf{Telescope Operator}, Bruneau Sand Dunes State Park Observatory \\
...
01/2019 --    &   \textbf{Volunteer}, Idaho Department of Corrections  \\
      ...
      & KIVI (11/2019), and in the Boise State University alumni magazine, \textit{Focus}, (05/2020). \\
      & \\
...
\begin{tabular}{ll}
\textbf{Physics \& Math:} &   Classical Mechanics (\textbf{Taylor}), Electrostatics \& Electrodynamics (\textbf{Griffiths}), \\
                  &   Introductory Quantum Mechanics (\textbf{Krane}), Introductory Relativity/Particle Physics, \\
                  &   Optics (\textbf{Pedrotti}), Thermal \& Statistical Physics (\textbf{Schroeder}), Astrophysics,\\
                  &   Intermediate Quantum Mechanics (Independent Study, \textbf{Townsend}), Cosmology (\textbf{Ryden}), \\
                  &   Circuits (\textbf{Scherz \& Monk}), Linear Algebra, Single \& Multivariable Calculus (\textbf{Stewart}),\\
...
\textbf{Computing:} &   Scientific Computing (\textbf{Newman}), Computational Mathematics, \\
                    &   Parallel Scientific Computing (graduate level course), Introductory Computer Science\vspace{1mm}
